...
Based on your previous exercises, use the same terminal from the Google Colab platform to test your knowledge on BASH commands. Scroll down to find a series of exercises which will demand choosing for specific flags to generate the desired output.
